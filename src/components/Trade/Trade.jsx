...
// customPaddings
// >
// <div className='absolute top-0 left-0 right-0 translate-y-[-1rem] flex justify-center items-center h-[100vh] xl:max-w-[1280px] xl:text-[1rem] mx-auto p-4'>
//     <div className='flex flex-col items-center'>
...
//             to={`/coin/${item.id}`}
//             key={item.id}
//             className="flex flex-col items-center text-center w-[15rem] h-auto select-none"
//             >
//             <img src={item.image} alt={item.name} width={90}/>
//             <p className="font-semibold mt-[0.5rem]">
//                 {item.name}{" "}
